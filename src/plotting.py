...
def draw_posteriors(problem, plot_options):
    ...
    if hypers:
        ...
        varnames = list(pc.hyperparameters.keys()) + ['like']
    else:
        sc = problem.config.sampler_config
        varnames = list(problem.rvs.keys()) + list(pc.hyperparameters.keys()) \
            + ['like']
...
def draw_correlation_hist(problem, plot_options):
    ...
    if hypers:
        sc = problem.config.hyper_sampler_config
        varnames = list(problem.config.problem_config.hyperparameters.keys())
    else:
        sc = problem.config.sampler_config
        varnames = list(problem.config.problem_config.select_variables()) + \
            ['like']
