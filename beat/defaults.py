...
default_bounds = dict(
    ...
    lon=(30.0, 30.5),
    omega=(0.5, 0.6),
    strike_traction=(-10, 10),
    dip_traction=(-10, 10),
    tensile_traction=(-10, 10),
    major_axis=(0.01, 10),
    minor_axis=(0.01, 10),
...
physical_bounds = dict(
    ...
    v=(-1.0 / 3, 1.0 / 3.0),
    w=(-3.0 / 8.0 * num.pi, 3.0 / 8.0 * num.pi),
    strike_traction=(-15000, 15000),
    dip_traction=(-15000, 15000),
    tensile_traction=(-15000, 15000),
    major_axis=(0.01, 100),
    minor_axis=(0.01, 100),
